...
# Update these environment variables with default values
SPEECHRECOGNITION_LANGUAGE = os.getenv("SPEECHRECOGNITION_LANGUAGE", "en-US")
TMP_DIR = os.getenv("TMP_DIR", "/tmp")
DATA_DIR = os.getenv("DATA_DIR", os.path.join(os.getcwd(), "data"))  # Default to 'data' in current directory
...
Queue = SqlQueue(os.path.join(DATA_DIR, "tmp", "async_js_sr.queue.db"))
